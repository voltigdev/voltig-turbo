...
const BUNDLE_ID = "dev.voltig.speed"; // ios bundle id
const PACKAGE = "dev.voltig.speed"; // android package name
const NAME = "Voltig Speed"; // app name
const EXPO_ACCOUNT_OWNER = "infra-voltig"; // expo account owner
const EAS_PROJECT_ID = "b471a1ce-67dc-415f-88bc-150ebf15c3f4"; // eas project id
const SCHEME = "voltig"; // app scheme
const slug="voltig-speed"
...
const client = z.object({
  ...
  VERSION: z.string(),
  SLUG: z.string(),
  // FIREBASE_FILE: z.string(),
  // ANDROID_FIREBASE_FILE: z.string(),
  // POSTHOG_API_KEY: z.string(),
  // POSTHOG_HOSTNAME: z.string(),
